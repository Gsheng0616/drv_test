...
static int __init gpio_drv_init(void)
{
	...
	/* 注册file_operations 	*/
	major = register_chrdev(0, "100ask_sr501", &gpio_key_drv);  /* /dev/gpio_desc */

	sr501_class = class_create(THIS_MODULE, "100ask_gpio_sr501_class");
	...
	device_create(sr501_class, NULL, MKDEV(major, 0), NULL, "100ask_sr501"); /* /dev/100ask_gpio */
